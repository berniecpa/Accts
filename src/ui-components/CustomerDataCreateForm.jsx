...
export default function CustomerDataCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setBillingPhone(initialValues.BillingPhone);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new CustomerData(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "CustomerDataCreateForm")}
      {...rest}
    >
      <TextField
        label="First name"
